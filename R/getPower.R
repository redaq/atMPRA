...
{		if(all(is.na(slope))|(length(slope)!=2*ntag*nsim&length(slope)!=1))
		...
		{	stop("The input distribution 'inputDist' needs to be specified, it should be of length nsim*ntag*2.\n")
		}
